        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-end">
            <div className="lg:col-span-8">
              <motion.div className="inline-flex items-center gap-2 px-3 py-1 bg-[#3D5AFE]/5 border border-[#3D5AFE]/20 mb-8">
                <Activity size={12} className="text-[#3D5AFE] animate-pulse" />
                <span className="text-[9px] font-[900] uppercase tracking-[0.3em] text-[#3D5AFE]">
                  Engineered Solutions 2026
                </span>
              </motion.div>

              <motion.h1 className="text-7xl md:text-[120px] font-[1000] uppercase italic tracking-tighter leading-[0.8] text-zinc-900 mb-12">
